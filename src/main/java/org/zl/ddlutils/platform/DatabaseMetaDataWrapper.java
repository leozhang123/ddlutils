...
public class DatabaseMetaDataWrapper {
	 ...
	 * 
	 * @param tableNamePattern The pattern identifying for which tables to return
	 *                         info
	 ...
	 * @param tableNamePattern  The pattern identifying for which tables to return
	 *                          info
	 * @param columnNamePattern The pattern identifying for which columns to return
	 *                          info
	...
	/**
	 * Convenience method to return the primary key meta data using the configured
	 * catalog and schema pattern.
	 * 
	 * @param tableNamePattern The pattern identifying for which tables to return
	 *                         info
	...
	/**
	 * Convenience method to return the foreign key meta data using the configured
	 * catalog and schema pattern.
	 * 
	 * @param tableNamePattern The pattern identifying for which tables to return
	 *                         info
	...
	/**
	 * Convenience method to return the index meta data using the configured catalog
	 * and schema pattern.
	 * 
	 * @param tableNamePattern The pattern identifying for which tables to return
	 *                         info
	 * @param unique           Whether to return only indices for unique values
	 * @param approximate      Whether the result is allowed to reflect approximate
	 ...
	 *
	 * @param searchStringPattern the search string pattern
	 */
